{!! Form::open(array('route' => ['complain.update_technical_action',$editComplain->complain_id],'method'=>'put','class'=>"form-horizontal",'id'=>"form1")) !!}
<!--end-->
<div class="panel panel-info">
    <div class="panel-heading">
        <h3 class="panel-title">Tindakan Aduan</h3>
    </div>
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3 col-xs-10">
                {!! Form::select('complain_status_id',$complain_statuses,$editComplain->complain_status_id,['class'=>'form-control ']) !!}
            </div>
